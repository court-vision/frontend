        ...
        {mockRoom && canSimulate && (
          <>
            <Button
              ...
              title={
                myTurnBlocker ??
                "Run the other seats up to your next pick (s). Simulated picks stop this room following an ESPN draft until they are undone."
              }
            ...
            <Button
              ...
              title="Run every remaining pick, yours included. Simulated picks stop this room following an ESPN draft until they are undone."
