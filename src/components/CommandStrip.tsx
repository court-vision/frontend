...
export function CommandStrip() {
  ...
  return (
    <header className="h-12 border-b border-border bg-card flex items-center px-4 gap-1.5 sticky top-0 z-50 shrink-0">
      {/* Mobile menu */}
      ...
      <button
        ...
        className="flex items-center gap-2 h-8 px-2.5 rounded-md border border-border bg-muted/30 hover:bg-muted hover:border-primary/30 transition-all text-muted-foreground hover:text-foreground"
      >
        <Search className="h-3 w-3" />
        <span className="hidden sm:inline text-xs">Search...</span>
        <kbd className="hidden sm:inline-flex h-4 items-center rounded border border-border bg-muted/50 px-1 font-mono text-[10px] text-muted-foreground/60">
