...
export const PROD_BACKEND_ENDPOINT = "https://cv-backend-production.up.railway.app";
export const DATABSE_API_ENDPOPINT = "https://cv-backend-production.up.railway.app/db";
export const LOCAL_BACKEND_ENDPOINT = "http://127.0.0.1:8000";
export const LINEUP_GENERATION_API_ENDPOINT = "TBD";
export const DATA_API_ENDPOINT = "https://cv-backend-443549036710.us-central1.run.app/data";
